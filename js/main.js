...
fetch('data/mozart.geojson')
    ...
    .then(data => {
        data.features.forEach(feature => {
            ...
            // --- Icon logic ---
            let icon;
            if (id.includes("mozarts_birthplace") || nameLower.includes("mozart residence")) {
                icon = iconBuilding;
            } else if (tourismType === "information" || nameLower.includes("info")) {
                icon = iconInfo;
            } else if (tourismType === "artwork") {
                icon = iconStatue;
            } else {
                icon = iconStatue; // fallback icon
            }
